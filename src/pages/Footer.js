            ...
            <div className="footer-social">
              <ul style={{listStyleType: "none"}} >
                {socialMediaLinks.map((link, index) => (
                  <SocialMediaIcon key={index} href={link.href} svgPath={link.svgPath} width={link.width} height={link.height} viewBoxHeight={link.viewBoxHeight} viewBoxWidth={link.viewBoxWidth}/>
                ))}
              </ul>
            </div>
